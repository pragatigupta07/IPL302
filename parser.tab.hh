...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // unary_operator
      char dummy12[sizeof (op_unary_astnode*)];

      // parameter_declaration
      char dummy13[sizeof (parameter_declaration_class*)];

      // parameter_list
      char dummy14[sizeof (parameter_list_class*)];

      // statement_list
      char dummy15[sizeof (seq_astnode*)];

      // statement
      // selection_statement
      // iteration_statement
      char dummy16[sizeof (statement_astnode*)];
      ...
      // type_specifier
      char dummy18[sizeof (type_specifier_class*)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_translation_unit = 48,                 // translation_unit
        S_struct_specifier = 49,                 // struct_specifier
        S_50_1 = 50,                             // $@1
        S_function_definition = 51,              // function_definition
        S_52_2 = 52,                             // $@2
        S_main_definition = 53,                  // main_definition
        S_54_3 = 54,                             // $@3
        S_type_specifier = 55,                   // type_specifier
        S_fun_declarator = 56,                   // fun_declarator
        S_parameter_list = 57,                   // parameter_list
        S_parameter_declaration = 58,            // parameter_declaration
        S_declarator_arr = 59,                   // declarator_arr
        S_declarator = 60,                       // declarator
        S_declaration_list = 61,                 // declaration_list
        S_declaration = 62,                      // declaration
        S_declarator_list = 63,                  // declarator_list
        S_compound_statement = 64,               // compound_statement
        S_statement_list = 65,                   // statement_list
        S_statement = 66,                        // statement
        S_assignment_expression = 67,            // assignment_expression
        S_assignment_statement = 68,             // assignment_statement
        S_procedure_call = 69,                   // procedure_call
        S_printf_call = 70,                      // printf_call
        S_expression = 71,                       // expression
        S_logical_and_expression = 72,           // logical_and_expression
        S_equality_expression = 73,              // equality_expression
        S_relational_expression = 74,            // relational_expression
        S_additive_expression = 75,              // additive_expression
        S_unary_expression = 76,                 // unary_expression
        S_multiplicative_expression = 77,        // multiplicative_expression
        S_postfix_expression = 78,               // postfix_expression
        S_primary_expression = 79,               // primary_expression
        S_expression_list = 80,                  // expression_list
        S_unary_operator = 81,                   // unary_operator
        S_selection_statement = 82,              // selection_statement
        S_iteration_statement = 83               // iteration_statement
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::MAIN <= tok && tok <= token::STRING_LITERAL));
#endif
      }
    };
